...
SELECT tri_grams.n_gram_1, tri_grams.n_gram_2,
SUM(CASE WHEN mn.gram LIKE '% nomn%' THEN tri_grams.match_count ELSE 0 END) AS nomn,
SUM(CASE WHEN mn.gram LIKE '% gent%' THEN tri_grams.match_count ELSE 0 END) AS gent,
SUM(CASE WHEN mn.gram LIKE '% datv%' THEN tri_grams.match_count ELSE 0 END) AS datv,
SUM(CASE WHEN mn.gram LIKE '% accs%' THEN tri_grams.match_count ELSE 0 END) AS accs,
SUM(CASE WHEN mn.gram LIKE '% ablt%' THEN tri_grams.match_count ELSE 0 END) AS ablt,
SUM(CASE WHEN mn.gram LIKE '% loct%' THEN tri_grams.match_count ELSE 0 END) AS loct
